...
function getUnProcessedUpdates() {
    ...
    var currTable = $('#uploadedTransTable').DataTable({
        ...
        "rowCallback": function (row, data) {
            ...
            checkbox.prop('checked', checkedRows[data.updateId] || false);
        },
