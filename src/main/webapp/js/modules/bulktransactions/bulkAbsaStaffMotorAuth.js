    ...
    var currTable = $('#loadedPolicyTable').DataTable({
        ...
        "columns": [
            ...
            {"data": "policyStatus"},
            {
                "data": "policyId",
                "render": function(data, type, full, meta) {
                    return '<form action="edituwtrans" method="post"><input type="hidden" name="id" value=' + full.policyId + '><input type="submit" class="btn btn-primary btn-sm" value="view"></form>';
                }
            }
        ],
