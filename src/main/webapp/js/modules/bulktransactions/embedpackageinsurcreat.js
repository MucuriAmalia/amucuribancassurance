...
function processTrans(button) {
    ...
    bootbox.confirm("Are you sure want to process this transaction?", function (result) {
        ...
        if (result) {
            Swal.fire({
                title: 'Processing...',
                text: 'Please wait while we process the policies.',
            ...
            $.ajax({
                type: 'POST',
                url: 'processsinglembedinsur/' + trans['embedPackageId'],
                dataType: 'json',
                async: true,
