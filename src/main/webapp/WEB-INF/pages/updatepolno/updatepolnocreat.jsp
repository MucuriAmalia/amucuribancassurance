...
<script type="text/javascript"
        src="<c:url value="/js/modules/updatepolno/updatepolnocreat.js"/>"></script>
<div class="x_panel">
    <div class="x_title">
        <h2><i class="fa fa-bars"></i> Update Underwriter Policy Numbers</h2>
    ...
    <div class="x_content">
        ...
        <a href="bulkUpdateUnderwriterTemplate" class="btn btn-success">
            <i class="fa fa-file-excel-o"></i> Download Template
        </a>

        <div class="x_title">
            <h2>Unprocessed policy update Listing</h2>
...
<jsp:include page="modals/updatepolicymodal.jsp"></jsp:include>