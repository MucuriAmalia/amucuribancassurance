...
<script type="text/javascript"
        src="<c:url value="/js/modules/bulktransactions/bulkPolRefund.js"/>"></script>

<div class="x_panel">
    <div class="x_title">
        <h2><i class="fa fa-bars"></i> Bulk Policy Refunds</h2>
    ...
    <div class="x_content">
        ...
        <a href="bulkpolrefundstemplate" class="btn btn-success">
