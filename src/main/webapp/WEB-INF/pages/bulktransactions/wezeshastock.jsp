...
<script type="text/javascript"
        src="<c:url value="/js/modules/bulktransactions/wezeshastock.js"/>"></script>
<div class="x_panel">
    <div class="x_title">
        <h2><i class="fa fa-bars"></i> Wezesha Policy Creation</h2>
    ...
    <div class="x_content">
        ...
        <a href="bulkwezeshatemplate" class="btn btn-success">
