...
<script type="text/javascript"
        src="<c:url value="/js/modules/bulktransactions/authorizedPolicy.js"/>"></script>
<div class="x_panel">
    <div class="x_title">
        <h2><i class="fa fa-bars"></i> Bulk Policy Authorization</h2>
    ...
    <div class="x_content">
        <div class="x_title">
            <h2>Unauthorized policies Listing</h2>
