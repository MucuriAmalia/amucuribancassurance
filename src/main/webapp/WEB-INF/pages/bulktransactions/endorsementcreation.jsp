...
<script type="text/javascript"
        src="<c:url value="/js/modules/bulktransactions/bulkPolENCreation.js"/>"></script>
<script>
...
<div class="x_panel">
    <div class="x_title">
        <h2><i class="fa fa-bars"></i> Bulk Endorsement Policy Creation</h2>
    ...
    <div class="x_content">
        ...
        <a href="bulkpolentemplate" class="btn btn-success">
        ...
        <div class="x_title">
            <h2>Unprocessed Endorsement policy Listing</h2>
