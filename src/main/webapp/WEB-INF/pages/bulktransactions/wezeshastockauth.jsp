...
<script type="text/javascript"
        src="<c:url value="/js/modules/bulktransactions/wezeshastockauth.js"/>"></script>
<div class="x_panel">
    <div class="x_title">
        <h2><i class="fa fa-bars"></i> Wezesha Policy Processing Authorization</h2>
    ...
    <div class="x_content">
        <div class="x_title">
            <h2>Unprocessed Wezesha policies</h2>
