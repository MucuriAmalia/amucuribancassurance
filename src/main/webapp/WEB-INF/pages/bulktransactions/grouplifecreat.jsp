...
<script type="text/javascript"
        src="<c:url value="/js/modules/bulktransactions/grouplifecreat.js"/>"></script>
<div class="x_panel">
    <div class="x_title">
        <h2><i class="fa fa-bars"></i> Group Life Upload Policy Creation</h2>
    ...
    <div class="x_content">
        ...
        <a href="bulkgrouplifetemplate" class="btn btn-success">
