...
<script type="text/javascript"
        src="<c:url value="/js/modules/bulktransactions/creditlifecreat.js"/>"></script>
<script>
...
<div class="x_panel">
  <div class="x_title">
    <h2><i class="fa fa-bars"></i> Credit Life Upload Policy Creation</h2>
  ...
  <div class="x_content">
    ...
    <a href="bulkcreditlifetemplate" class="btn btn-success">
