...
<script type="text/javascript"
        src="<c:url value="/js/modules/bulktransactions/mortgagelifecreat.js"/>"></script>
<script>
    window.ctx = '${pageContext.request.contextPath}';
</script>
<div class="x_panel">
    <div class="x_title">
        <h2><i class="fa fa-bars"></i> Mortgage Life Upload Creation</h2>
    ...
    <div class="x_content">
        ...
        <a href="bulkmortagelifetemplate" class="btn btn-success">
