...
<script type="text/javascript"
        src="<c:url value="/js/modules/bulktransactions/bulkcancelationauth.js"/>"></script>
<div class="x_panel">
    <div class="x_title">
        <h2><i class="fa fa-bars"></i> Bulk Cancellations Authorization </h2>
    ...
    <div class="x_content">
        <div class="x_title">
            <h2> Unauthorized Bulk Cancellations Listing </h2>
