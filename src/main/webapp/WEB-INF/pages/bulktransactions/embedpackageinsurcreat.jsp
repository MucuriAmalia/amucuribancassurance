...
<script type="text/javascript"
        src="<c:url value="/js/modules/bulktransactions/embedpackageinsurcreat.js"/>"></script>
<script>
...
<div class="x_panel">
  <div class="x_title">
    <h2><i class="fa fa-bars"></i> Bulk Embedded Packaged Insurance Policy Creation</h2>
  ...
  <div class="x_content">
    ...
    <a href="bulkembpkgintemplate" class="btn btn-success">
