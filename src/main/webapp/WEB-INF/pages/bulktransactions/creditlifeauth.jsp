...
<script type="text/javascript"
        src="<c:url value="/js/modules/bulktransactions/creditlifeauth.js"/>"></script>
<div class="x_panel">
    <div class="x_title">
        <h2><i class="fa fa-bars"></i> Credit Life Upload Policy Authorization </h2>
    ...
    <div class="x_content">
        <div class="x_title">
            <h2> Unauthorized policy Listing </h2>
...
<%--                    <th></th>--%>
        ...
        <div style="margin-top: 20px;">
            <button class="btn btn-danger float-right" id="bulk-delete-processed-policy">Bulk Delete</button>
