...
<script type="text/javascript"
        src="<c:url value="/js/modules/bulktransactions/bulkpolprocessing.js"/>"></script>
<div class="x_panel">
    <div class="x_title">
        <h2><i class="fa fa-bars"></i> Bulk Policy Process Authorization</h2>
    ...
    <div class="x_content">
        <div class="x_title">
            <h2>Unprocessed policies Listing</h2>
        ...
        <div style="margin-top: 20px;">
            ...
            <button class="btn btn-primary float-right" id="bulk-authorize-policy">Bulk Authorize</button>
        </div>
    </div>
</div>
