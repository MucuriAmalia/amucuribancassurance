...
<script type="text/javascript"
        src="<c:url value="/js/modules/bulktransactions/bulkAbsaStaffMotorlCreation.js"/>"></script>

<div class="x_panel">
    <div class="x_title">
        <h2><i class="fa fa-bars"></i> ABSA Staff Motor Policy Creation</h2>
    ...
    <div class="x_content">
        ...
        <a href="bulkabsastaffmotortemplate" class="btn btn-success">
