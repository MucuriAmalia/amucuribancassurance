...
<script type="text/javascript"
        src="<c:url value="/js/modules/bulktransactions/creditcardcreat.js"/>"></script>
<div class="x_panel">
    <div class="x_title">
        <h2><i class="fa fa-bars"></i> Payment Card Policy Creation</h2>
    ...
    <div class="x_content">
        ...
        <a href="bulkcreditcardtemplate" class="btn btn-success">
