...
<script type="text/javascript"
        src="<c:url value="/js/modules/bulktransactions/creditshieldcreat.js"/>"></script>
<div class="x_panel">
    <div class="x_title">
        <h2><i class="fa fa-bars"></i> Credit Shield Policy Creation</h2>
    ...
    <div class="x_content">
        ...
        <a href="bulkcreditshieldtemplate" class="btn btn-success">
