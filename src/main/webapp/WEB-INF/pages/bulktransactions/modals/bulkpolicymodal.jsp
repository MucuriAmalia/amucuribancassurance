        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="item form-group" id="progress-container" style="display: none;">
                        <label class="label-align col-md-5">Upload Progress</label>
                        <div class="col-md-7 col-xs-12">
                            <div class="progress">
                                <div class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100" style="width: 0%;" id="upload-progress">0%</div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    <input type="submit" class="btn btn-success" style="margin-right: 10px;" value="Upload" id="upload-btn">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <ul style="list-style-type: none;" class="reports-links">
                            ...
                            <li>
                                <a id="unprocessed-trans-link" href="javascript:void(0);" target="_blank">Uploaded
                                    Policies</a>
                            </li>
                        </ul>
                    </div>
