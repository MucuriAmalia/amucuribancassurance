...
<div class="x_panel">
    <div class="x_title">
        <h2><i class="fa fa-bars"></i> Authorised Requistions</h2>
            ...
            .DataTable(
                {
                    ...
                    "columns": [
                        ...
                        },
                        {
                            "data": "ctNo",
                            "render": function (data, type, full, meta) {
                                return '<button type="button" class="btn btn-success btn btn-info btn-sm" type="button" data-trans=' + encodeURI(JSON.stringify(full)) + '  onclick="updateRequistion(this);">Update</button>';
