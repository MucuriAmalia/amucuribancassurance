    ...
    <div class="x_content">
        ...
        <form:form class="form-horizontal" action="reviseTransaction"
            ...
            <div class="item form-group form-required">
                <div class="col-md-6 col-xs-12">
                    <label for="rev-type" class="col-md-6 label-align">Type of Revision</label>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                // Store endorsement types when Next button is clicked
                $('form').on('submit', function(e) {
                    var revType = $('#rev-type').val();
                    var conditionalType = $('#conditional-type').val();


                    sessionStorage.setItem('revisionType', revType);
                    sessionStorage.setItem('endorsementType', conditionalType);

                    console.log('Stored revisionType:', revType);
                    console.log('Stored endorsementType:', conditionalType);
                });
            });
        </script>
    </div>
