...
<script type="text/javascript" src="<c:url value="/js/modules/receipts/creditorCommissions.js"/>"></script>
<div class="x_panel">
    <div class="x_title">
        <h2><i class="fa fa-bars"></i> Commission Processing</h2>
    ...
    <div class="x_content">
        <form id="credits-form" class="form-horizontal">
            ...
            <div class="item form-group">
                <div class="col-md-6 col-xs-12">
                    <label for="rec-type" class="label-align col-md-5 col-xs-12"> Commission Type: <span
                            class="required">*</span></label>
                    <div class="col-md-7 col-xs-12">
                        <select class="form-control" id="rec-type" name="selreceiptType" required>
                            <option value="">Select Commission Type</option>
                            <option value="C">Commissions</option>
                            <option value="A">Admin Fees</option>
                        </select>
                    </div>
                    <div class="col-md-3">
                    </div>
