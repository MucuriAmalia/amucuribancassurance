...
<div class="x_panel">
    <div class="x_title">
        <h2><i class="fa fa-bars"></i> Creditor Payments</h2>
    ...
    <div class="x_content">
        <form id="credits-form" class="form-horizontal">
            ...
            <div class="item form-group">
                <div class="col-md-6 col-xs-12">
                    <label for="brn-id" class="col-md-5 label-align">Intermediary
                    </label>
            ...
            <div class="item form-group">
                <div class="col-md-6 col-xs-12">
                    <label for="brn-id" class="col-md-5 label-align">Payment Status
                    </label>
