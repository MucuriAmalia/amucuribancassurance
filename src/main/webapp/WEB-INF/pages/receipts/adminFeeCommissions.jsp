...
<script type="text/javascript" src="<c:url value="/js/modules/receipts/adminFeeCommissions.js"/>"></script>
<div class="x_panel">
    <div class="x_title">
        <h2><i class="fa fa-bars"></i> Admin Fee Commission Payment</h2>
        ...
        <form id="admin-fee-form" class="form-horizontal">
            <div class="item form-group">
                ...
                <div class="col-md-6 col-xs-12">
                    ...
                    <div class="col-md-7 col-xs-12">
                        <div class='input-group date datepicker-input' id="admin-wef-date">
                            <input type='text' class="form-control float-right" name="wefDate"
                                   id="admin-from-date" required />
                ...
                <div class="col-md-6 col-xs-12">
                    ...
                    <div class="col-md-7 col-xs-12">
                        <div class='input-group date datepicker-input' id="admin-cover-to-date">
                            <input type='text' class="form-control float-right" name="wetDate"
                                   id="admin-wet-date" required />
                            <div class="input-group-addon">
                                <span class="fa fa-calendar"></span>
                            </div>
                        </div>
            ...
            <div class="item form-group">
                ...
                <div class="col-md-6 col-xs-12">
                    ...
                    <div class="col-md-7 col-xs-12">
                        <input type='hidden' class="form-control float-right"
                               id="admin-cur-id" name="curCode" />
                        <div id="admin-curr-frm" class="form-control"
...
<%--                    <th>WHTX</th>--%>
        ...
        <span class="float-right"> <input type="text" class="form-control admin-total" disabled></span>
        <input type="hidden" id="admin-total-val" value="0">
        <button class="btn btn-primary float-right" id="process_admin_trans">Process Transactions</button>
    </div>
</div>
<div class="x_panel">
    <div class="x_title">
    ...
    <div class="x_content">
        <div class="card-box table-responsive">
            <table id="admin-instrans-tbl" class="table" style="width:100%">
                <thead>
                <tr>
...
<div class="x_panel">
    ...
    <div class="x_content">
        <div class="card-box table-responsive">
            <table id="admin-payment-trans-tbl" class="table" style="width:100%">
                <thead>
                <tr>
                    <th>Reference No</th>
                    <th>Policy No</th>
