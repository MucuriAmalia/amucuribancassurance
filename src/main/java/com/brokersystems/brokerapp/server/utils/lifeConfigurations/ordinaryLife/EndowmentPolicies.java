...
@Component
public class EndowmentPolicies {
    @Autowired
    ...
    public void getEndowmentPolicyPremium(List<PremiumItemsBean> premItems,
        ...
        System.out.println("sheetname form class handling endowment" + sheetName);
        if (sheet.getSheetName().equalsIgnoreCase(sheetName) && (sheetName.equalsIgnoreCase("SA-Endowment Policy Quote") || sheetName.equalsIgnoreCase("PRE-Endowment Policy Quote"))) {
            ...
            // Exclude null premiums
            BigDecimal premium = premItems.stream()
                    .filter(PremiumItemsBean::isMainSection)
                    .map(PremiumItemsBean::getPremium)
                    .filter(Objects::nonNull) // Exclude null premiums
                    .findAny()
                    .orElse(BigDecimal.ZERO);
            System.out.println("premium at stream");
            ...
            CellReference taxReliefCell = new CellReference("E67");
        ...
        if (sheet.getSheetName().equalsIgnoreCase(sheetName) && sheetName.equalsIgnoreCase("EndowmentInputs") ) {
            System.out.println("Sheet name " + sheet.getSheetName());
            System.out.println(sheetName);
        }
