...
public class TermPolicies {
    ...
    public void getTermPolicyPremium(List<PremiumItemsBean> premItems,
        ...
        if (sheet.getSheetName().equalsIgnoreCase(sheetName) && (sheetName.equalsIgnoreCase("SA-Term Assurance Policy Quote") || sheetName.equalsIgnoreCase("PRE-Term Assurance Policy Quote"))) {
            ...
            CellReference cashBackReference = new CellReference("E47");
            rows = cashBackReference.getRow();
            col = cashBackReference.getCol();
            Row cashBackRow = sheet.getRow(rows);
            Cell cashBackCell = cashBackRow.getCell(col);
            if (cashBackCell.getCellType() == Cell.CELL_TYPE_FORMULA) {
                FormulaEvaluator evaluator = workbook.getCreationHelper().createFormulaEvaluator();
                CellValue cellValue = evaluator.evaluate(cashBackCell);
                if (cellValue.getNumberValue() != 0) {
                    premiumResultBean.setTaxRelief(cellValue.getNumberValue());
                }
            }

            CellReference freqReference = new CellReference("E20");
            ...
            CellReference assuredReference = new CellReference("E14");
            ...
            CellReference monthlyReference = new CellReference("E15");
            ...
            CellReference quartelyReference = new CellReference("E16");
            ...
            CellReference semiAnnualReference = new CellReference("E17");
            ...
            CellReference annualReference = new CellReference("E18");
            ...
            CellReference taxReliefCell = new CellReference("E49");
            rows = taxReliefCell.getRow();
            col = taxReliefCell.getCol();
            System.out.println(">>>>>>>>>>>>>rows"+rows);
            System.out.println(">>>>>>>>>>>>>col"+col);
            Row taxRow = sheet.getRow(rows);
            System.out.println(">>>>>>>>>>>>>tax row"+taxRow);
            if (taxRow == null) {
                System.out.println("Row not found, creating new row at index: " + rows);
                taxRow = sheet.createRow(rows);
            }
            System.out.println(">>>>>>>>>>>>>taxrow"+taxRow);
            Cell taxCell = taxRow.getCell(col);
            System.out.println(">>>>>>>>>>>>>taxcell"+taxCell);
            if (taxCell == null) {
                System.out.println("Cell not found, creating new cell at column index: " + col);
            ...
            CellReference taxReliefReference = new CellReference("E49");
