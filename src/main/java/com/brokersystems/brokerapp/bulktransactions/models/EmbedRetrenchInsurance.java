...
@Entity
@Table(name = "sys_brk_embed_retrench_insurance")
public class EmbedRetrenchInsurance extends AuditBaseEntity implements Serializable {
    @Id
    @GeneratedValue(strategy= GenerationType.AUTO)
    @Column(name = "retrench_id")
    private Long retrenchId;

    @Column(name = "retrench_serial_no")
    private String serialNo;

    @Column(name = "retrench_client_name")
    private String clientName;

    @Column(name = "retrench_client_other_names")
    private String clientOtherNames;

    @Column(name = "retrench_client_dob")
    private Date clientDOB;

    @Column(name = "retrench_client_id")
    private String clientId;

    @Column(name = "retrench_client_pin")
    private String clientPin;

    @Column(name = "retrench_client_email")
    private String clientEmail;

    @Column(name = "retrench_client_phone")
    private String clientPhone;

    @ManyToOne
    @JoinColumn(name="retrench_client_cou_code")
    private Country countryCode;

    @JsonIgnore
    @ManyToOne(fetch = FetchType.EAGER)
    @JoinColumn(name="retrench_client_clnt_type")
    private ClientTypes tenantType;

    @Column(name = "retrench_trans_date")
    private Date transDate;

    @Column(name = "retrench_trans_status")
    private String tranStatus;

    @Column(name = "retrench_trans_type")
    private String transType;

    @Column(name = "embed_client_cif")
    private String clientCIF;

    @Column(name = "retrench_product_group")
    private String productGroup;

    @Column(name = "embed_product_name")
    private String productName;

    @Column(name = "retrench_cover_type")
    private String coverType;

    @XmlTransient
    @ManyToOne
    @JoinColumn(name = "retrench_currecy_code")
    private Currencies currencyCode;

    @Column(name = "retrench_payment_frequency")
    private String frequency;

    @XmlTransient
    @ManyToOne
    @JoinColumn(name = "retrench_insurer_code")
    private AccountDef insurerCode;

    @Column(name = "retrench_cover_from")
    private Date coverFrom;

    @Column(name = "retrench_processed_date")
    private Date processedDate;

    @XmlTransient
    @ManyToOne
    @JoinColumn(name = "retrench_processed_by")
    private User processedBy;

    @Column(name = "retrench_upload_date")
    private Date uploadDate;

    @Column(name = "retrench_cover_to")
    private Date coverTo;

    @XmlTransient
    @ManyToOne
    @JoinColumn(name = "retrench_policy_pol_id")
    ...
    @XmlTransient
    @ManyToOne
    @JoinColumn(name = "retrench_branch_code")
    private OrgBranch orgBranch;

    @Column(name = "retrench_ref_code")
    ...
    public Long getRetrenchId() {
        return retrenchId;
    }

    public void setRetrenchId(Long retrenchId) {
        this.retrenchId = retrenchId;
    }
