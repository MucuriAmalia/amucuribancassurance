 ...
 * under the License.
 */
package com.brokersystems.brokerapp.jobs.jobs.annotation;

import com.brokersystems.brokerapp.jobs.jobs.service.JobName;
...
public class CronMethodParser {
    ...
    private static final String SEARCH_PACKAGE = "com.brokersystems.brokerapp.";
                ...
                if (metadataSet != null && metadataSet.size() > 0) {
                    for (final MethodMetadata metadata : metadataSet) {
                        ...
                        if(attributes.get(attributeName) instanceof String){
                            final JobName attributeValue = Enum.valueOf(JobName.class,(String) attributes.get(attributeName)) ;
