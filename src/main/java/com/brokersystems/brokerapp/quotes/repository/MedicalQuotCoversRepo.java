...
/**
 * Created by waititu on 26/09/2017.
 */
public interface MedicalQuotCoversRepo extends PagingAndSortingRepository<MedicalCovers , Long> ,QueryDslPredicateExecutor<MedicalCovers>{
    @Query(value = "select a.med_id,b.sc_desc,b.sc_sht_desc from sys_brk_med_covers a\n" +
            ...
            "not in (select qcb_cov_id from sys_brk_quot_cat_benefits where qcb_cat_id=:catId) and a.med_bd_code=:bindCode",nativeQuery = true)
